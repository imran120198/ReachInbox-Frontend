  ...
  return (
    ...
    >
      ...
      <Stack padding="8px 12px 16px 12px">
        ...
        <Flex {...styleProps}>
          <Text color={colorMode == "light" ? "#637381" : "white"}>
            Contact No
          </Text>
          <Text color={colorMode == "light" ? "black" : "#B9B9B9"}>
            {user["Contact No"]}
      ...
      >
        ...
        <Flex fontSize="12px" gap="10px">
          <Text
            borderRight="1px"
            borderColor={colorMode == "light" ? "#D8D8D8" : "#343A40"}
            paddingRight="10px"
          >
            <span fontWeight="400">3</span> Steps
          </Text>
          <Text>
            <span fontWeight="400">5</span> Days in Sequence
          </Text>
        </Flex>

        <Stack textAlign="left" w="100%" spacing="32px">
          <Flex gap="16px">
            <Box
              {...boxStyleProps}
